...
export default function UpPJ() {
        ...
        const timer2 = setTimeout(() => {
            Axios.get("http://localhost:3001/login_admin_check").then((response) => {
              ...
              if (response.data.loggedIn_admin == true) {
                setAd_name(response.data.user[0].ad_name);
                setAd_username(response.data.user[0].ad_username);
              }
            });
        },300);

        const timer3 = setTimeout(() => {
            Axios.get("http://localhost:3001/project_history_admin").then((response) => {
    ...
    const addProject = () => {
        ...
        Axios.post("http://localhost:3001/up_project_admin", {
          th_name: th_name,
          en_name: en_name,
          proj_keyword: proj_keyword,
          employee: employee,
    ...
    const handleClose = () => window.location = '/MUser';
    ...
    return (
        ...
        {loginStatus == true ?
          ...
          ><Avatar icon={<UserOutlined />} sx={{borderRadius: 3, width:70 , height: 70}}></Avatar><div>{ad_name}</div>
          </Box >
                </Container>
