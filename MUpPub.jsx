...
export default function UpPJ() {
    ...
    const [ad_username, setAd_username] = useState(null);
    ...
    useEffect(() => {
        ...
        const timer4 = setTimeout(() => {
            Axios.get("http://localhost:3001/publication_history_admin").then((response) => {
    ...
    const addPublication = () => {
        ...
        Axios.post("http://localhost:3001/up_publication_admin", {
            title: title,
            author: author,
